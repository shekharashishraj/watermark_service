...
| O-SCD online | Illumination change, s=3 | 0.061 | 0.732 | 97.63% | 98.41% |
| O-SCD online | Lost coverage, 80% removed | 0.063 | 0.817 | 98.00% | 100.00% |
| O-SCD online | Fewer views, 75% removed | 0.083 | 0.815 | 96.87% | 91.67% |
...
| O-SCD offline (refined) | Illumination change, s=3 | 0.061 | 0.775 | 97.45% | 100.00% |
| O-SCD offline (refined) | Lost coverage, 80% removed | 0.064 | 0.961 | 97.97% | 100.00% |
| O-SCD offline (refined) | Fewer views, 75% removed | 0.070 | 0.812 | 96.93% | 91.67% |
...
| O-SCD online | frames localised by PnP | 0.25 (n=84) | 61.29% | 0.00% | 50.30% | 50.76% | 41.81% | - | 71.05% | 66.67% | 59.28% |
| O-SCD offline (refined) | frames localised by PnP | 0.36 (n=84) | 61.29% | 0.00% | 50.30% | 50.76% | 41.81% | - | 71.05% | 66.67% | 59.28% |
...
| Underexposure | -3 EV (-30%); steepest -3 EV to -4 EV (-0.265) | none; steepest -2 EV to -3 EV (-0.021) | -4 EV (-26%); steepest -3 EV to -4 EV (-0.031) | -4 EV (-28%); steepest -3 EV to -4 EV (-0.032) | -2 EV (-34%); steepest -2 EV to -3 EV (-0.075) |
...
| Illumination change | none; steepest s=2 to s=3 (-0.157) | none | none; steepest s=2 to s=3 (-0.016) | none; steepest s=2 to s=3 (-0.014) | s=2 (-28%); steepest s=1 to s=2 (-0.072) |
| Depth degradation | x1 (-36%); steepest reference to x1 (-0.230) | x1 (-41%); steepest reference to x1 (-0.226) | - | - | - |
| Lost coverage | none; steepest 40% removed to 60% removed (-0.063) | none; steepest 40% removed to 60% removed (-0.092) | none | none; steepest 60% removed to 80% removed (-0.007) | none |
| Fewer views | 50% removed (-45%); steepest reference to 50% removed (-0.298) | 50% removed (-44%); steepest reference to 50% removed (-0.256) | none; steepest reference to 50% removed (-0.017) | none; steepest reference to 50% removed (-0.044) | none |
...
| O-SCD online | frame F1 | 0.239 | 0.244 | 0.240 | 0.230 | 0.209* | 0.178* |
| O-SCD online | false alarms | 23.13% | 25.01% | 30.96% | 34.98% | 39.70% | 46.79%* |
| O-SCD online | ECE | 0.379 | 0.402 | 0.397 | 0.423 | 0.439 | 0.462 |
| O-SCD offline (refined) | frame F1 | 0.271 | 0.262 | 0.256 | 0.240* | 0.225* | 0.194* |
| O-SCD offline (refined) | false alarms | 27.59% | 30.79% | 33.44% | 35.78% | 38.50% | 41.97%* |
| O-SCD offline (refined) | ECE | 0.295 | 0.323 | 0.338 | 0.368 | 0.388 | 0.436* |
...
| Ours, confirmed only | false alarms | 0.07% | 0.07% | 0.07% | 0.07% | 0.07% |
| Ours, confirmed only | ECE | 0.014 | 0.014 | 0.014 | 0.014 | 0.015 |
| O-SCD online | frame F1 | 0.300 | 0.269 | 0.241 | 0.229 | 0.213 |
| O-SCD online | false alarms | 20.96% | 22.76% | 26.63% | 27.90% | 33.42% |
| O-SCD online | ECE | 0.381 | 0.392 | 0.400 | 0.408 | 0.419 |
| O-SCD offline (refined) | frame F1 | 0.315 | 0.288 | 0.250 | 0.236 | 0.222 |
| O-SCD offline (refined) | false alarms | 23.88%* | 26.61% | 32.83% | 31.76% | 35.16% |
| O-SCD offline (refined) | ECE | 0.282 | 0.306 | 0.342 | 0.338 | 0.363* |
...
| O-SCD online | frame F1 | 0.310 | 0.377 | 0.402 | 0.462 | 0.473 |
| O-SCD online | false alarms | 33.81% | 27.33% | 30.95% | 30.19% | 30.73% |
| O-SCD online | ECE | 0.379 | 0.378 | 0.428 | 0.426 | 0.450 |
| O-SCD offline (refined) | frame F1 | 0.361 | 0.467 | 0.463* | 0.469 | 0.462 |
| O-SCD offline (refined) | false alarms | 33.78% | 29.95% | 31.86% | 31.61% | 33.21%* |
| O-SCD offline (refined) | ECE | 0.295 | 0.310 | 0.340 | 0.338 | 0.339 |
...
| O-SCD online | frame F1 | 0.230 | 0.214 | 0.263 |
| O-SCD online | false alarms | 21.38% | 24.02%* | 23.49% |
| O-SCD online | ECE | 0.379 | 0.387 | 0.405* |
| O-SCD offline (refined) | frame F1 | 0.269 | 0.224 | 0.229 |
| O-SCD offline (refined) | false alarms | 22.99% | 28.22% | 30.05% |
| O-SCD offline (refined) | ECE | 0.295 | 0.300 | 0.285 |
...
| O-SCD online | Illumination change, s=3 | 0.419 | 0.028 | 0.053 | 0.50 | 0.04% | 8.17% |
| O-SCD online | Lost coverage, 80% removed | 0.450 | 0.015 | 0.068 | 0.50 | 0.00% | 0.00% |
| O-SCD online | Fewer views, 75% removed | 0.405 | 0.019 | 0.074 | 0.50 | 0.00% | 0.75% |
...
| O-SCD offline (refined) | Illumination change, s=3 | 0.363 | 0.034 | 0.095 | 0.85 | 20.49% | 22.93% |
| O-SCD offline (refined) | Lost coverage, 80% removed | 0.339 | 0.067 | 0.103 | 0.82 | 59.81% | 9.73% |
| O-SCD offline (refined) | Fewer views, 75% removed | 0.285 | 0.043 | 0.088 | 0.88 | 38.81% | 48.53% |
...
| Illumination change, s=3 | 0.262 / 0.221 / 0.083 | 0.258 / 0.208 / 0.138 |
...
| Illumination change | -12% | -11% | -28% |
| Depth degradation | - | - | -100% |
| Lost coverage | +53% | +28% | -25% |
| Fewer views | +14% | -15% | -69% |
...
| O-SCD online | most severe | 0.69 | 0.78 | 0.76 | 0.62 | 0.73 | 0.68 |
| O-SCD offline (refined) | reference | 1.00 | 1.00 | 1.00 | 0.88 | 0.93 | 1.00 |
| O-SCD offline (refined) | most severe | 0.72 | 0.78 | 0.76 | 0.74 | 0.78 | 0.70 |
